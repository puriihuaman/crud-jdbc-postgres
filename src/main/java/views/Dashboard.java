...
public class Dashboard extends JFrame {
	...
	private void initComponents() {
		...
		Form.setForeground(new java.awt.Color(51, 51, 51));
		...
		txtCode.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204,
			204,
			204
		), 1, true));
		...
		txtProductName.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204,
			204,
			204
		), 1, true));
		...
		txtPrice.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204,
			204,
			204
		), 1, true));
		...
		txtStock.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204,
			204,
			204
		), 1, true));
		txtStock.setMargin(new java.awt.Insets(2, 16, 2, 6));

		btnSearch.setBackground(new java.awt.Color(255, 255, 255));
		btnSearch.setFont(new java.awt.Font("Roboto", 0, 16)); // NOI18N
		btnSearch.setForeground(new java.awt.Color(0, 153, 255));
		btnSearch.setText("Buscar");
		btnSearch.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255,
			255,
			255
		), 1, true));
		...
		btnRegister.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255,
			255,
			255
		), 1, true));
		...
		btnUpdate.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255,
			255,
			255
		), 1, true));
		...
		btnDelete.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255,
			255,
			255
		), 1, true));
		...
		lblAlertMessage.setBackground(new java.awt.Color(255, 255, 255));
		...
		jScrollPane1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204,
			204,
			204
		), 1, true));
		...
		tblProducts.setForeground(new java.awt.Color(51, 51, 51));
	...
	private void btnSearchActionPerformed(ActionEvent evt) {
		...
		if (!productToSearch.isEmpty() && !productToSearch.isBlank() &&
			...
			if (products.size() == 0) {
				alertMessage("No hay ninguna coincidencia con " + productToSearch,
					"success"
				);
				uploadProducts();
				return;
	...
	private Product validateFields() {
		...
		try {
			...
			alertMessage("Ingrese un valor positivo!.", "error");
			isValid = false;
		}

		if (price < 0 || stock < 0) {
			alertMessage("Ingrese un valor mayor a cero!.", "error");
			isValid = false;
		}
	...
	private void alertMessage(String _message, String _type) {
		switch (_type) {
			case "success" -> lblAlertMessage.setForeground(new Color(0, 194, 8));
			case "error" -> lblAlertMessage.setForeground(new Color(252, 87, 87));
			case "warning" -> lblAlertMessage.setForeground(new Color(246, 205, 5));
		}
